...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="actualizarPassword.css">
    ...
    <body style="background-color: #93b49e">
        ...
        <div class="container-fluid" style="padding-top: 50px; padding-bottom: 100px; background-color: #93b49e">
            <div class="row">
                <div class="col">
                    <form class="formulario" autocomplete="off" action="updatePass.php" method="POST">
                        <!--Titulo-->
                        ...
                        <div class="form-group" style="margin-top: 30px">
                            ...
                            <a href="login.php"><button type="button" class="btn btn-success btn-lg" style="margin-left: 5px">Prefiero mantener la contraseña</button></a>
                        </div>
                    </form>
                </div><!--Fin col-->
            </div>
